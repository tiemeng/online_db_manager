...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            ...
            <a href="{{route('rules.create')}}" link-url="javascript:void(0)"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 添加菜单</button></a>
