                ...
                <form class="form-horizontal m-t-md" action="{{ route('admins.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="text" autocomplete="off" class="form-control" name="name" value="{{old('name')}}" required data-msg-required="请输入用户名">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            <input type="password" autocomplete="new-password" class="form-control" name="password" required data-msg-required="请输入密码">
